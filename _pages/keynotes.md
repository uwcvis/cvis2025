...
keynotes:
  - title: |
    ...
    time: Dec 15th 10:00am-11:00pm
    url: https://jescresswell.github.io/
    image: assets/images/speakers/JessieCresswell.png
    abstract: |
    ...
    author: 
      name: Dr. Jesse Cresswell
      affiliation: Layer 6 AI, TD Bank
      description:
      bio: |
  ...
  - title: "Artificial Intelligence for Music, from Audio to Video, from Cyber to Physical"
    ...
    authors:
      - name: Prof. Yung-Hsiang Lu
        affiliation: Purdue University
        url: https://yhlu.net/
        image: assets/images/speakers/yung-lu.jpeg
        bio: |
      ...
      - name: Prof. Kristen Yeon-Ji Yun
        affiliation: Purdue University
        url: https://www.cla.purdue.edu/directory/profiles/yeon-ji-kristen-yun.html
  ...
  - title: |
    ...
    image: assets/images/speakers/RyanGariepy.jpeg
    abstract: |
...
{% assign keynote = page.keynotes[0] %}
<div class="keynote-section">
  ...
  {% if keynote.abstract %}
  <div class="keynote-abstract" style="margin: 2rem 0;">
    <h4>Abstract</h4>
...
{% assign keynote = page.keynotes[1] %}
<div class="keynote-section">
  <div class="keynote-meta">
    {% if keynote.time %}
    <div class="keynote-time">{{ keynote.time }}</div>
  ...
  {% if keynote.authors %}
    <div style="display: grid; gap: 3rem; margin-top: 2rem;">
      {% for author in keynote.authors %}
      <div class="keynote-content">
        <div class="keynote-image-wrapper">
          <img src="{{ author.image | relative_url }}" alt="{{ author.name }}" class="keynote-image">
        </div>
        
        <div class="keynote-details">
          <div class="keynote-speaker">
            <h4 class="speaker-name">{{ author.name }}</h4>
            {% if author.affiliation %}
            <p style="font-style: italic; color: #7f8c8d;">{{ author.affiliation }}</p>
            {% endif %}
            {% if author.url %}
            <p><a href="{{ author.url }}" target="_blank" rel="noopener noreferrer" style="color: var(--primary-color);">{{ author.url }}</a></p>
            {% endif %}
          </div>
...
{% assign keynote = page.keynotes[3] %}
<div class="keynote-section">
  <div class="keynote-meta">
    {% if keynote.time %}
    <div class="keynote-time">{{ keynote.time }}</div>
